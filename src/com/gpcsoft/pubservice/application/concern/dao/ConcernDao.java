...
public interface ConcernDao extends BaseGenericDao<Concern> {
	...
	/**
	 * Description :  条件判断
	 * Create Date: 2011-7-1下午03:48:42 by zhaojf  Modified Date: 2011-7-1下午03:48:42 by zhaojf
	 * @param   
	 * @return  
	 * @Exception
	 */
	public boolean isExistClient(Map<String, Object> paramMap);
