...
/** 
  *  Comments: <strong>定时调整结束投标的项目</strong>            		
  *	 <br/>		        																							
  *  <br/>CopyRright (c)2008-xxxx:   珠海政采软件技术有限公司    		
  *  <br/>Project:   srplatform                    					          
  *  <br/>Module ID: 权限平台     		
  *  <br/>Create Date：2010-9-10 上午10:13:22 by liuy    					                            
  *  <br/>Modified Date:  2010-9-10 上午10:13:22 by liuy  
  */ 
public class ProjectEndBidTimeTask extends TimerTask {
	...
	public void run() {
		 if (!isRunning) { 
			 	logger.info(""+ProjectEndBidTimeTask.class.getSimpleName()+" is running!");
		        isRunning = true; 
		        projectPlanService.updateEndBid();
		        isRunning = false; 
		    }else { 
		    	logger.info("上次任务未完成。。。。。。");
		    } 
