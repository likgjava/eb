...
/** 
  ...
  *   @version: 0.5 
  */ 
public class ProjectRuleDesion implements ProjectPlanDesion{
	...
	public Boolean endDecide(ProjectPlan projectPlan, Object bizObject)throws Exception {
		ProjProcessRule projProcessRule = (ProjProcessRule)bizObject;
		projProcessRule.getProject().setUseStatus(CommonEnum.USER_STATUS_FORMAL);
		this.getProjProcessRuleManager().save(projProcessRule, ProjProcessRule.class);
		return true;
	}
