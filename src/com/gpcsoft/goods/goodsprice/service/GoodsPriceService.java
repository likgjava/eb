...
public interface GoodsPriceService extends BaseGenericService<GoodsPrice> {
	 ...
	 * @Exception   
	 */
	Boolean savePrice(Map<String, Object> param) throws Exception;
	 ...
	 * @Exception   
	 */
	Boolean updateAuditStatus(Map<String, Object> param)throws Exception;
	 ...
	 * @Exception   
	 */
	List<ListOrderedMap> getGoodsSalesChart(Map<String, Object> param) throws Exception;
