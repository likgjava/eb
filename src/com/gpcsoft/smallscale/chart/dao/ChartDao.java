package com.gpcsoft.smallscale.chart.dao;
...
public interface ChartDao extends BaseGenericDao<GpcBaseObject> {
	 ...
	 * @Exception   
	 */
	List<Object[]> getSaveAmountByMonth(Map<String, Object> param) throws Exception;
	 ...
	 * @Exception   
	 */
	List<Object[]> getPlanActualSaveQtyByMonth(Map<String, Object> param) throws Exception;
	 ...
	 * @Exception   
	 */
	List<Object[]> getPurcategoryAmountQtySaveByMonth(Map<String, Object> param) throws Exception;
	 ...
	 * @Exception   
	 */
	List<Object[]> getEbuymethodAmountQtyByMonth(Map<String, Object> param) throws Exception;
