...
@Repository
public class RealGiftRecordDaoHibernate extends BaseGenericDaoHibernate<RealGiftRecord> implements RealGiftRecordDao {
	...
	public List<RealGiftRecord> getRecordListByGiftId(final String objId) throws Exception {
		return (List<RealGiftRecord>) getHibernateTemplate().execute(new HibernateCallback(){
			public Object doInHibernate(Session session)
					throws HibernateException, SQLException {
					String Hql = " from RealGiftRecord where gift.objId = :objId and dealStatus = :dealStatus ";
