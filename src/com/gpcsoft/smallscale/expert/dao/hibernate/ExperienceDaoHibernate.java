...
@Repository
public class ExperienceDaoHibernate extends BaseGenericDaoHibernate<Experience> implements ExperienceDao {
	...
	public Integer updateExperienceAuditStatus(final String objIds, final String auditStatus){
		return (Integer)getHibernateTemplate().execute(new HibernateCallback(){
			public Object doInHibernate(Session session) throws HibernateException, SQLException {
				StringBuilder hql = new StringBuilder();
				Query query = null;
				if(StringUtils.hasLength(objIds)){
					hql.append("update Experience t set t.auditStatus =:auditStatus where t.objId in (:objId)");
