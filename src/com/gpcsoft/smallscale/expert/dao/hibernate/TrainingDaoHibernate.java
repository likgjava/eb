...
@Repository
public class TrainingDaoHibernate extends BaseGenericDaoHibernate<Training> implements TrainingDao {
	...
	public Integer updateTrainingAuditStatus(final String objIds, final String auditStatus){
		return (Integer)getHibernateTemplate().execute(new HibernateCallback(){
			public Object doInHibernate(Session session) throws HibernateException, SQLException {
				StringBuilder hql = new StringBuilder();
				Query query = null;
				if(StringUtils.hasLength(objIds)){
					hql.append("update Training t set t.auditStatus =:auditStatus where t.objId in (:objId)");
