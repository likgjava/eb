...
public class RecommendProjectEnum 
{
	/**
     * 审核状态[00:待审核, 01:审核通过, 02:审核不通过]
     */
    public final static String AUDIT_STATUS = "recommendProject.auditStatus";
	...
	{
        return ((EnumService)FrameBeanFactory.getBean(EnumServiceImpl.BEAN_NAME)).getDescByValue(RecommendProjectEnum.AUDIT_STATUS, str);
	}
}
