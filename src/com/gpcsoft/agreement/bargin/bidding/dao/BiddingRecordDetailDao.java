...
public interface BiddingRecordDetailDao extends BaseGenericDao<BiddingRecordDetail> {
	 ...
	 * @Exception   
	 */
	List<Object[]> getBiddingRankChartDate(Map<String, Object> param) throws Exception;
}
