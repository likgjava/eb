...
public interface ShoppingCartItemService extends BaseGenericService<ShoppingCartItem> {
	 ...
	 * @Exception   
	 */
	void saveAppendGoodsToShoppingCart(ShoppingCartItem shoppingCartItem,String protaskItemObjId) throws Exception;
