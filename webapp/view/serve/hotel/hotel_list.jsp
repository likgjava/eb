...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/serve/hotel/hotel_list.js"></script>
...
<div class="formTips attention">
	<ul>
		<li>
			<em>注意：</em><spring:message code="com.gpcsoft.serve.hotel.notModifyPrompt"/>
		</li>
		<li>
			新增酒店请点击
			<span class="sysicon siAdd"><a id="addHotelBtn" href="javascript:void(0);"><strong>新增酒店</strong></a></span>.
		</li>
	</ul>
</div>
<div id="epsTabs">
  <ul>
    <li>
      <a href="#hotelListPage" id = "auditStatus_00" class="refreshData"><span>待提交</span></a>
    </li>
    <li>
      <a href="#hotelListPage" id = "auditStatus_01" class="refreshData"><span>待审核</span></a>
    </li>
    <li>
      <a href="#hotelListPage" id = "auditStatus_03" class="refreshData"><span>被退回</span></a>
    </li>
    <li>
