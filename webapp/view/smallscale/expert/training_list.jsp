...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/smallscale/expert/training_list.js"></script>

<!-- 导航显示 -->
<div class="nextBar">
    <ol class="num5">
        <li class="done"><span class="first">1. 填写基本信息</span></li> 
        <li class="done current-prev"><span>2. 填写教育背景</span></li>
        <li class="current"><span>3. 填写培训经历</span></li>
...
<div class="formTips attention">
	<ul>
		<li>
			<em id="attentionAdd">新增培训信息请点击
			<span class="sysicon siAdd"><a id="addExpertInfoBtn" href="javascript:void(0);"><strong>新增培训信息</strong></a></span>
			</em>
			<em id="attentionModify" class="hidden">,当前培训信息修改后将重新进行审核！</em>
		</li>
	</ul>
</div>
