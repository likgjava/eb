...
projectPlanDetail.toProject=function(planId,projectId){
	$('#conBody').empty().loadPage($('#initPath').val()+'/ProjectController.do?method=toProjectInfo&objId='+projectId+'&planId='+planId);
...
<flex:flexgrid checkbox="false"
	id="projectPlanDetailGrid" url="ProjectPlanController.do?method=list" queryColumns="isLeaf,path,level,parent.objId,resource.objId"  
		...
		onSubmit="projectPlanDetail.before" onSuccess="projectPlanDetail.success">
				<flex:flexCol name="name" display="projectPlanForm.name" sortable="true" width="120"align="left"></flex:flexCol>
				...
				<flex:flexCol name="startDate" display="projectPlanForm.startDate" sortable="true" width="130"align="center"></flex:flexCol>
