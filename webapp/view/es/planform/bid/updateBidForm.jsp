...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/es/planform/bid/updateBidForm.js"></script>
				...
				<div>
					<table>
						...
						<tr>
							...
							<td colspan="3">
								<input type="text" name="bidLinkerIdCard" id="bidLinkerIdCard" class="required" value="${bid.bidLinkerIdCard }"/>
								<span class="eleRequired">*</span>
							</td>
						</tr>
						<tr>
