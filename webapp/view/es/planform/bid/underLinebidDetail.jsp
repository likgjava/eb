...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/es/planform/bid/underLinebidDetail.js"></script>
		     		...
		     		<tr>
						...
						<td>
							<span id="supplierName"><c:out value="${signUprecord.supplier.orgName}"/></span> 
								<input type="hidden" name="supplier.objId" id="supplier.objI" value="${signUprecord.supplier.objId}">
						</td>
					</tr>	
						<tr>
