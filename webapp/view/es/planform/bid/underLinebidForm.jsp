...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/es/planform/bid/underLinebidForm.js"></script>
		...
		<div class="formLayout form2Pa">
				...
				<table>
		     		<tr>
						...
						<tr>
							...
							<td colspan="3">
								<input type="text" name="bidQuoteSum" id="bidQuoteSum" class="required" value="${bid.bidQuoteSum}"/>
								<span class="eleRequired">*</span>
							</td>
						</tr>
				...
				<div>
					<table>
						<tr>
							...
							<td colspan="3">
								<input type="text" name="bidLinker" id="bidLinker" class="required" value="${signUprecord.linker}" />
								<span class="eleRequired">*</span>
							</td>
						</tr>
						<tr>
							...
							<td colspan="3">
								<input type="text" name="bidLinkerIdCard" id="bidLinkerIdCard" class="required" value="${signUprecord.idCard}"/>
								<span class="eleRequired">*</span>
							</td>
						</tr>
					</table>
			...
			<table>
			   <tr>
        		...
        		<td colspan="3">
        		<div class="uploadFile" id="attachRelaId">${bid.attachRelaId}</div>
        		</td>
			  </tr>
			</table>
			</div>
