...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/es/planform/contract/contractOperInfoDetail.js"></script>

<div class="formLayout form2Pa">
	<form id="contractOperInfoDetailForm" method="post">
		<input type="hidden" name="objId" id="objId" value="<c:out value="${param.objId}"/>"/>
     	<h4><span></span></h4>
		   ...
		   <div class="conOperation">
				<button type="button" id="contractOperInfoReturn" type="button" tabindex="20""><span><spring:message code="globe.return"/></span></button>
		   </div>
	</form>
</div>
