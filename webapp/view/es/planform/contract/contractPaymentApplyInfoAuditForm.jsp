...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/es/planform/contract/contractPaymentApplyInfoAuditForm.js"></script>
<div class="formLayout form2Pa">
	<form id="contractPaymentApplyInfoAuditForm" method="post">
		<input type="hidden" name="objId" id="objId" value="<c:out value="${param.objId}"/>"/>
     	<h4><span></span></h4>
     	<ul>
	     	<li>
	     		<label for="contractPaymentApplyInfoAuditForm.opinion"><spring:message code="contractPaymentApplyInfoAuditForm.opinion"/></label>
		   ...
		   <div class="conOperation">
				<button type="button" id="contractPaymentApplyInfoAuditSave"><span><spring:message code="globe.save"/></span></button>
				<button type="button" name="historyBackBtn" tabindex="19""><span><spring:message code="globe.return"/></span></button>
				<button type="button" id="contractPaymentApplyInfoAuditReset" type="button" tabindex="20""><span><spring:message code="globe.reset"/></span></button>
		   </div>
	</form>
</div>
