...
<head>
	...
	<title></title>
	<script type="text/javascript" src="<%=request.getContextPath()%>/view/es/planform/contract/witnessPartyList.js"></script>
</head>
<body>	  

	<form id="witnessPartySearchZone" >
		<div class="conSearch">
	...
	<flex:flexgrid checkbox="true"
		id="witnessPartyGrid" url="WitnessPartyController.do?method=list" queryColumns=""  
			searchZone="witnessPartySearchZone" rp="10" title="" width="800" height="200" 
			onSubmit="witnessPartyList.before" onSuccess="witnessPartyList.success">
		...
		<flex:flexBtn name="globe.new" bclass="add" onpress="witnessPartyList.add"></flex:flexBtn>	
		<flex:flexBtn name="globe.modify" bclass="add" onpress="witnessPartyList.update"></flex:flexBtn>	
		<flex:flexBtn name="globe.delete" bclass="delete" onpress="witnessPartyList.remove"></flex:flexBtn>	
	</flex:flexgrid>
</body>
</html>
