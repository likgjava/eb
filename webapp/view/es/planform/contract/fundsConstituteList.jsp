...
<head>
	...
	<title></title>
	<script type="text/javascript" src="<%=request.getContextPath()%>/view/es/planform/contract/fundsConstituteList.js"></script>
</head>
<body>	  

	<form id="fundsConstituteSearchZone" >
		<div class="conSearch">
	...
	<flex:flexgrid checkbox="true"
		id="fundsConstituteGrid" url="FundsConstituteController.do?method=list" queryColumns=""  
			searchZone="fundsConstituteSearchZone" rp="10" title="" width="800" height="200" 
			onSubmit="fundsConstituteList.before" onSuccess="fundsConstituteList.success">
		...
		<flex:flexBtn name="globe.new" bclass="add" onpress="fundsConstituteList.add"></flex:flexBtn>	
		<flex:flexBtn name="globe.modify" bclass="add" onpress="fundsConstituteList.update"></flex:flexBtn>	
		<flex:flexBtn name="globe.delete" bclass="delete" onpress="fundsConstituteList.remove"></flex:flexBtn>	
	</flex:flexgrid>
</body>
</html>
