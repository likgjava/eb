...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/es/planform/contract/contractSupplierForm.js"></script>
		...
		<input type="hidden" name="objId" id="objId" value="<c:out value="${param.objId}"/>"/>
     	...
     	<ul>
		   ...
		   <div class="conOperation">
				<button type="button" id="contractSupplierSave"><span><spring:message code="globe.save"/></span></button>
				<button type="button" name="historyBackBtn" tabindex="19""><span><spring:message code="globe.return"/></span></button>
				<button type="button" id="contractSupplierReset" type="button" tabindex="20""><span><spring:message code="globe.reset"/></span></button>
		   </div>
	</form>
</div>
