...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/es/planform/contract/contractPaymentApplyInfoForm.js"></script>
<div class="formLayout form2Pa">
	<form id="contractPaymentApplyInfoForm" method="post">
		<input type="hidden" name="objId" id="objId" value="<c:out value="${param.objId}"/>"/>
     	...
     	<ul>
		   ...
		   <div class="conOperation">
				<button type="button" id="contractPaymentApplyInfoSave"><span><spring:message code="globe.save"/></span></button>
				<button type="button" name="historyBackBtn" tabindex="19""><span><spring:message code="globe.return"/></span></button>
				<button type="button" id="contractPaymentApplyInfoReset" type="button" tabindex="20""><span><spring:message code="globe.reset"/></span></button>
		   </div>
	</form>
</div>
