...
<head>
	...
	<title></title>
	<script type="text/javascript" src="<%=request.getContextPath()%>/view/es/planform/contract/clauseDetailList.js"></script>
</head>
<body>	  

	<form id="clauseDetailSearchZone" >
		<div class="conSearch">
	...
	<flex:flexgrid checkbox="true"
		id="clauseDetailGrid" url="ClauseDetailController.do?method=list" queryColumns=""  
			searchZone="clauseDetailSearchZone" rp="10" title="项目" width="800" height="200" 
			onSubmit="clauseDetailList.before" onSuccess="clauseDetailList.success">
		...
		<flex:flexBtn name="globe.new" bclass="add" onpress="clauseDetailList.add"></flex:flexBtn>	
		<flex:flexBtn name="globe.modify" bclass="add" onpress="clauseDetailList.update"></flex:flexBtn>	
		<flex:flexBtn name="globe.delete" bclass="delete" onpress="clauseDetailList.remove"></flex:flexBtn>	
	</flex:flexgrid>
</body>
</html>
