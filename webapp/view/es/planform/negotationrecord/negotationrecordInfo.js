...
$(document).ready(function(){
	...
	negotationrecordInfo.getOpenBidUser = function(subProjectId,i){//点击包组
		...
		$('#openBidList').loadPage($('#initPath').val()+'/NegotationRecordController.do?method=toNegotationrecordList&projectId='+projectId+'&subProjectId='+subProjectId);
	}
	...
	if (projProcessRule=='TRUE') {//判断是否分包开标
		...
		$('#openBidList').loadPage($('#initPath').val()+'/NegotationRecordController.do?method=toNegotationrecordList&projectId='+projectId);
	}
