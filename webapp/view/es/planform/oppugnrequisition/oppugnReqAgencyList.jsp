...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/es/planform/oppugnrequisition/oppugnReqAgencyList.js"></script>
<style>
<!--
...
<flex:flexgrid checkbox="false" 
	id="oppugnRequisitionGrid" url="OppugnRequisitionController.do?method=list" queryColumns=""  
		searchZone="oppugnRequisitionSearchZone" rp="10" title="质疑" height="200" 
