		...
		<input type="hidden" name="factorType.objId" value="${congruousFactor.factorType.objId}"/>
     	<ul>
    	    ...
    	    <li class="fullLine">	
					...
					<input type="text" name="score" id="score" class="required floats" value="${congruousFactor.score}"  style="width:60px;" />
	   	   			<span class="eleRequired">*</span>
	    	 </li>
    	      <li class="fullLine">	
    	    ...
    	    <c:if test="${param.scoreNum > 0.0 || param.scoreNum > 0}">
    	      ...
    	      <li class="fullLine">	
	     			...
	     			<html:select styleClass="required" id="auditMethod" name="auditMethod" code="auditMethod" selectedValue="${congruousFactor.auditMethod}" disabled="true">
						</html:select>
	   	   			<span class="eleRequired">*</span>
	    	 </li>
    	    <li class="fullLine">
