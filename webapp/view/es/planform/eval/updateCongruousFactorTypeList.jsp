...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/es/planform/eval/updateCongruousFactorTypeList.js"></script>
				...
				<c:forEach items="${congruousFactorTypeList}" var="congruousFactorType" >
					<tr>
						<c:if test='${congruousFactorType.typeCode != "competencyAudit"}'>
							...
							<td>
								<input type="text" name="congruousFactorType[${num}].typeName" value="${congruousFactorType.typeName}" style="width: 160px;" maxlength="25"/>
...
<div class="conOperation">
	...
	<button id="congruousFactor" type="button" tabindex="18"><span>维护指标</span></button>
</div>