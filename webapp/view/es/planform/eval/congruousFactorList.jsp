...
<head>
	...
	<title></title>
	<script type="text/javascript" src="<%=request.getContextPath()%>/view/es/planform/eval/congruousFactorList.js"></script>
...
<body>
	...
	<flex:flexgrid checkbox="false"
		...
		<flex:flexBtn name="新增指标" bclass="add" onpress="congruousFactorList.add"></flex:flexBtn>
		<flex:flexBtn name="新增指标分类" bclass="add" onpress="congruousFactorList.addType"></flex:flexBtn>
		<flex:flexBtn name="修改指标分类" bclass="sysicon siModify" onpress="congruousFactorList.updateType"></flex:flexBtn>
		<flex:flexBtn name="删除指标分类" bclass="sysicon siDelete" onpress="congruousFactorList.deleteType"></flex:flexBtn>
	</flex:flexgrid>
