...
<%@ include file="/view/srplatform/common/taglibs.jsp"%>  
   <div id="superviseDoDiv1" style="overflow: auto;width: 98%" class="">
...
<script language="javascript">
   ...
   //获取所有的审核过的招标文件
	function getEvalBidRecordListBySubProjId(subProjId){
		...
		$("#superviseTabDiv1").loadPage($("#initPath").val()+"/EvaSellerRecordController.do?method=toSecondTrialPageDetail&type="+$("#type").val()+"&subProjId="+subProjId);
	}
