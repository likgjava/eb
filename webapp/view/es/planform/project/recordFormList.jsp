...
<head>
	...
	<title></title>
	<script type="text/javascript" src="<%=request.getContextPath()%>/view/es/planform/Record/recordFormList.js"></script>
</head>
<body>	  
	...
	<flex:flexgrid checkbox="true"
		id="recordFormGrid" url="RecordFormController.do?method=list" queryColumns=""  
			searchZone="recordFormSearchZone" rp="10" title="备案书" width="800" height="200" 
		...
		<flex:flexBtn name="globe.modify" bclass="add" onpress="recordFormList.update"></flex:flexBtn>	
