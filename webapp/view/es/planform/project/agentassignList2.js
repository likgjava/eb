...
taskPlanList.leader = function(name,grid)
{
	...
	//设定返回路径
	$("#returnUrl").val($('#initPath').val()+"/view/es/planform/project/agentassignList2.jsp");
	$('#conBody').loadPage($('#initPath').val()+'/TaskPlanController.do?method=getBuyMethod&objId='+$(grid).getSelect());
}
