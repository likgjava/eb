...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/es/planform/project/puaseProjectListForAudit.js"></script>
<style>
<!--
...
<div id="puaseProjectListView">
	<flex:flexgrid checkbox="false"	id="puaseProjectGrid" url="ProjectController.do?method=topuaseProjectListForAudit" queryColumns="objId,projProcessStatus"  
		searchZone="puaseProjectZone" rp="10" title="暂停项目列表"  height="305"
		onSubmit="puaseProjectList.before" onSuccess="puaseProjectList.success">
				...
				<flex:flexCol name="agencies.orgName" display="招标中心" sortable="true" width="170"align="left"></flex:flexCol>
				<flex:flexCol name="createTime" display="立项日期" format="date" sortable="true" width="100"align="center"></flex:flexCol>
				<flex:flexCol name="projProcessStatus" display="业务状态" alias="projProcessStatusCN" sortable="true" width="100"align="center"></flex:flexCol>
	</flex:flexgrid>
</div>
