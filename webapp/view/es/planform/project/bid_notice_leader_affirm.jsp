...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/es/planform/project/bid_notice_leader_affirm.js"></script>
<div class="formLayout">
<span style="margin-left:5px">当前位置：采购预告 >> 主管领导审批</span>
...
<div id="preNoticeAffirm">
	<ul style="padding-top:0px">
		...
		<li>
			<label>审批结果</label>
			<input type="radio" name="radio" checked="checked"/>通过 <input type="radio" name="radio" id="refuse" />不通过 
		</li>
		<li>
			<label>审批意见</label>
			<textarea id="input20" cols="50" rows="5" ></textarea>
		</li>
		<li>
