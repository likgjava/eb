...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/es/planform/project/project_supplierForTab.js"></script>
...
<div id="projectTop" class="accountInfo" >
	 ...
	 <div style=" width:100%; height:60px; padding-bottom:5px;background-color:#F2F9FF;" class="accountInfo">
