...
<script language="javascript">
	...
	$(document).ready(function(){
		projectList2.loadProjectList = function(tenderType){
			$("#consignListView").loadPage($('#initPath').val()+'/ProjectController.do?method=searchProjectListDljgBiXuan2&tenderType='+tenderType+'&serviceName='+$("#serviceName").val()+'&projProcessStatus='+$("#projProcessStatus1").val());
		} 
		...
		projectList2.loadProjectList('05');
		$('#epsTabs').tabs();
