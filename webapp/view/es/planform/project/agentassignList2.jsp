...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/es/planform/project/agentassignList2.js"></script>
...
<div id="epsTabs">
  <div id="taskPlanListInfo">
	  <flex:flexgrid checkbox="true"
		id="taskPlanGrid" url="TaskPlanController.do?method=getAssigEbuyMethodList" queryColumns=""  
		...
		<flex:flexBtn name="设置采购方式" bclass="audit" onpress="taskPlanList.leader"></flex:flexBtn>		
	</flex:flexgrid>
  </div>
</div>