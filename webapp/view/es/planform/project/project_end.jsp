...
<div class="partContainers operationLog"><h5 id="performancebond"><span class="switch  left11">项目结项</span></h5></div>
    <div id="endDetail">
...
resultPublishedList.success = function(){
	$("#resultPublishedListGrid").flexAddOptionStr({
		  '<button class="btn" type="button"><span><span>结项</span></span></button>' : function(btn,rowId,obj){
				 btn.click(function(){
