...
//		}
		if (ebuyMethod=='03') {//询价
			$("#tabform").empty().loadPage($('#initPath').val()+'/InqpDocController.do?method=toPurchaseDocConfig&isComplete=true&projectId='+$("#projectId").val());
		}else {//公开招标
			$("#tabform").empty().loadPage($('#initPath').val()+'/PurchaseDocController.do?method=toPurchaseDocConfig&isComplete=true&fromType=fromList&projectId='+$("#projectId").val());
		}
	})
	//澄清文件
