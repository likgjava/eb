...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/es/planform/project/puaseProjectList.js"></script>
<style>
<!--
...
<div id="puaseProjectListView">
	<flex:flexgrid checkbox="false"	id="puaseProjectGrid" url="ProjectController.do?method=topuaseProjectList" queryColumns="objId,projProcessStatus"  
		...
		onSubmit="puaseProjectList.before" onSuccess="puaseProjectList.success">
				<flex:flexCol name="projCode" display="招标编号" sortable="true" width="170"align="center"></flex:flexCol>
				...
				<flex:flexCol name="projProcessStatus" display="业务状态" sortable="true" width="100"align="center"></flex:flexCol>
	</flex:flexgrid>
</div>
