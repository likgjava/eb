...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/es/planform/project/agentassignList4.js"></script>
...
<div id="epsTabs">
  <div id="taskPlanListInfo">
	  <flex:flexgrid checkbox="true"
		id="taskPlanGrid" url="TaskPlanController.do?method=getAssigAgentlist" queryColumns=""  
		...
		<flex:flexBtn name="指定招标中心" bclass="audit" onpress="taskPlanList.leader"></flex:flexBtn>		
	</flex:flexgrid>
  </div>
</div>