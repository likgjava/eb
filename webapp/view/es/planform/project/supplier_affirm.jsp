...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/es/planform/project/supplier_affirm.js"></script>
<div class="formLayout">

 <div class="partContainers operationLog"><h5 id="supplierAffirm"><span class="switch  left11">确认报名</span></h5>	</div>
    <div id="supplierAffirmDetail">
 ...
 <div class="conOperation" align="center">
   <button type="button" id="saveBtn"><span>确认报名</span></button>
 </div>
  </div>
 </div>
