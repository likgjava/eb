...
$(document).ready(function(){
	...
	//指标展现
	$('#congrousFactor').empty().loadPage($('#initPath').val()+"/CongruousFactorController.do?method=toFactorTabShow&projectId="+$("input[id='project.objId']").val());
	//使用工具制作按钮单击事件
...
$('#historyId').click(function(){
	$("#historyView").loadPage($('#initPath').val()+"/CompletedWorkTaskController.do?method=getCompletedWorkTaskByBizId&bizId="+$("input[name='project.objId']").val()+'&taskType=03');
});
