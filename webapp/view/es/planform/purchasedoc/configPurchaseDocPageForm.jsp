...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/es/planform/purchasedoc/configPurchaseDocPageForm.js"></script>
<div class="formLayout">
			...
			<ul style="padding-top:0px">
				<li class="formTextarea">
					<label>意见</label>
					<textarea name="opinion" id="opinion" class="maxInput" maxlength="200"></textarea>
				</li>
				<li>
