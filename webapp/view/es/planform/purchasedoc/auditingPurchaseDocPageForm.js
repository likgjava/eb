...
purchaseDocDeptAudit.auditBulletin = function(){
	$.getJSON($('#initPath').val()+'/PurchaseDocController.do?method=purchaseDocDeptAudit&auditStatus='+$("#auditStatus").val(), formToJsonObject('purchaseDocDeptAuditForm'), function(json){
