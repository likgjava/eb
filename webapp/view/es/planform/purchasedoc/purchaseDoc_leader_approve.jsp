...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/es/planform/purchasedoc/purchaseDoc_leader_approve.js"></script>
...
<div class="formLayout">        
	<form id="purchaseDocLeaderApproveForm" method="post">
     		<ul>
					 <li>			
			<label>审核结果</label>
