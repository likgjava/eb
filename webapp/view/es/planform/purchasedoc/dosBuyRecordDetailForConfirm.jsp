...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/es/planform/purchasedoc/dosBuyRecordDetailForConfirm.js"></script>
	...
	<h5><span>审核意见</span></h5>
		...
		<ul>
			<li style="height:50px;">
				<input type="hidden" name="dosBuyRecordId" id="dosBuyRecordId" value="${dosBuyRecord.objId}"/>
