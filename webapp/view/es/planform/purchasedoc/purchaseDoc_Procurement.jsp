...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/es/planform/purchasedoc/purchaseDoc_Procurement.js"></script>
...
<div class="formLayout" >        
			...
			--%>
					...
					<li>
						...
						<div class="hidden" id="downAddr"><%=request.getContextPath()%>/PurchaseDocController.do?method=downLoadPurFile&objId=${attrId}</div>
								<a class="sysicon siDownBtn" href="<%=request.getContextPath()%>/PurchaseDocController.do?method=downLoadPurFile&objId=${attrId}"  id="downLoad" title="点击下载【${attrName}】"><span>${attrName}</span></a>	
					</li> -->
					<li>
