var mydesktop_supervise = {};
	...
	mydesktop_supervise.getResultBulletin = function(subProject,i){
		...
		$("#tab"+i).addClass('selected ui-tabs-selected ui-state-active');
		$("#superviseTabDiv").empty();
		$('#superviseTabDiv').loadPage($('#initPath').val()+'/ResultPublicityController.do?method=toResultPublicity&isComplete=true&projectId='+subProject);
	}
