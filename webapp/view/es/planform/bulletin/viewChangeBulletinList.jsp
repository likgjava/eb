...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/es/planform/bulletin/viewChangeBulletinList.js"></script>
<style>
<!--
...
<div id="epsTabs" class="">
  <ul>
  	<li>
      <a href="#contractInfo" id = "tabs_submit" class="refreshData"><span>提交审核</span></a>
    </li>
    <li>
      <a href="#contractInfo" id = "tabs_wait" class="refreshData"><span>审核中</span></a>
    </li>
    <li>
      <a href="#contractInfo" id = "tabs_pass" class="refreshData"><span>审核通过</span></a>
    </li>
    <li>
      <a href="#contractInfo" id = "tabs_notpass" class="refreshData"><span>被退回</span></a>
    </li>
  </ul>
  <div id="contractInfo">
    <flex:flexgrid checkbox="false" height="266"
		id="BulletinGrid" url="BulletinController.do?method=getBulletinList&bullType=11" queryColumns=""
