...
<div class="partContainers">
    	...
    	<h5><dm:out value="local__RESULTBULLETIN" tenderType="${project.tenderType}" ebuyMethod="${project.ebuyMethod}">中标公告</dm:out>信息</h5>
				<ul>
					<li>
			...
			<form id="assignDeptForm">
			 <div class="conOperation">
				   <button type="button" id="releaseBtn"><span>发布<dm:out value="local__RESULTBULLETIN" tenderType="${project.tenderType}" ebuyMethod="${project.ebuyMethod}">中标公告</dm:out></span></button>
			</div> 
			</form>
		</div>
</div>