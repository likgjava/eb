...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/es/planform/bulletin/resultBulletinView.js"></script>       
	...
	<div class="formLayout form2Pa">
		...
		<h5><span>基本信息</span></h5>
			<ul>
				...
				<li>
					<label class="short" for="bullTitle"><spring:message code="bulletinForm.bullTitle"/>：</label>
					<input type="text" name="bullTitle" id="bullTitle" class="required" value="${bulletin.bullTitle }"/>
					<span class="eleRequired">*</span> 	  
				</li>

				<li>
					<label class="short" for="bulletinNo"><spring:message code="bulletinForm.bulletinNo"/>：</label>
