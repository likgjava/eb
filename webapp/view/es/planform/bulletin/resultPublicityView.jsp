...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/es/planform/bulletin/resultPublicityView.js"></script>       
...
<form id="bulletinForm" method="post">
	<div class="formLayout form2Pa">
		...
		<input type="hidden" name="project.objId" id="project.objId" value="${subproject.objId}"/>
