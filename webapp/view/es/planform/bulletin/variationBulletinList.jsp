...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/es/planform/bulletin/variationBulletinList.js"></script>
...
<div id="variationTabId">
  <ul>
 	<li>
     <a href="#variationListInfo" id = "tabs_toTemp" class="refreshData"><span>起草</span></a>
   </li>
 	<li>
   ...
   <li>
 	...
 	<li>
     <a href="#variationListInfo" id = "tabs_toAdjust" class="refreshData"><span>被退回</span></a>
   </li>
</ul>
  <div id="variationListInfo">
	  <flex:flexgrid checkbox="true"
		id="variationBulletinGrid" url="BulletinController.do?method=list" queryColumns=""  
			searchZone="variationSearchZone" rp="10"  title="公告列表" onSuccess="variationList.success" 
			onSubmit="variationList.before">
		...
		<flex:flexBtn name="globe.new" bclass="add" onpress="variationList.add"></flex:flexBtn>	
		<flex:flexBtn name="批量删除" bclass="delete" onpress="variationList.delMore"></flex:flexBtn>	
	</flex:flexgrid>
  </div>
</div>
