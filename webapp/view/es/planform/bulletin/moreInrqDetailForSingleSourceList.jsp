...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/es/planform/bulletin/moreInrqDetailForSingleSourceList.js"></script>
 <style type="text/css">
<!--
...
<div id="epsTabs" class="">
  <div id="InrqDetailInfo">
    <flex:flexgrid checkbox="false" height="305"
		id="InrqDetailGrid" url="InrqDetailController.do?method=searchInrqDetailByQueryObject" queryColumns=""
