...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/es/planform/clarificationDoc/clarificationDocListForBuyer.js"></script>
<style type="text/css">
<!--
...
<div id="variationTabId">
  <ul>
 	<li>
     <a href="#variationListInfo" id = "tabs_toTemp" class="refreshData"><span>待确认</span></a>
   </li>
   <li>
  ...
  <div id="variationListInfo">
	  <flex:flexgrid checkbox="false"
		id="purchaseDocGrid" url="PurchaseDocController.do?method=list" queryColumns=""  
			searchZone="purchaseDocSearchZone" rp="10"  title="澄清文件列表" onSuccess="purchaseDocList2.success" 
			onSubmit="purchaseDocList2.before">
