...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/es/planform/clarificationDoc/clarificationDocList.js"></script>
<style type="text/css">
<!--
...
<div id="variationTabId">
  <ul>
 	...
 	<li>
     <a href="#variationListInfo" id = "tabs_toFormal" class="refreshData"><span>待确认</span></a>
   </li>
 	<li>
     <a href="#variationListInfo" id = "tabs_toQDJCJ" class="refreshData"><span>待监察局审核</span></a>
   </li>
 	<li>
