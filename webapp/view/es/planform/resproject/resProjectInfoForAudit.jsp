...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/es/planform/resproject/resProjectInfoForAudit.js"></script>
<div class="paper"> 
<p class="headInfo">&nbsp;</p>
			...
			<ul>
				<li>
					<form id="recordFormAudit" method="post">
						<input type="hidden" value="${resProject.objId}" id="resProjectId"/>
