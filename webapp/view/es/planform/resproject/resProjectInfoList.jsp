...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/es/planform/resproject/resProjectInfoList.js"></script>
...
<div id="epsTabs">
	<ul>
	  	<li>
	      <a href="#resProjectInfo" id = "tabs_toTemp" class="refreshData"><span>待申请</span></a>
	    </li>
	    <li>
	   ...
	   <li>
	    <a href="#resProjectInfo" id = "tabs_aleradyCreateHistory" class="refreshData"><span>查看历史</span></a>
	    </li>
   </ul>
   <div id="resProjectInfo">
	<flex:flexgrid  id="resProjectListGrid" url="ResProjectController.do?method=list&recordForm.auditStatus=01&useStatus=00" 
