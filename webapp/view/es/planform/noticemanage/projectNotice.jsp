...
<head>
	...
	<title></title>
	<script type="text/javascript" src="<%=request.getContextPath()%>/view/es/planform/noticemanage/projectNotice.js"></script>
</head>
<body>	  
	...
	<flex:flexgrid checkbox="true"
		...
		<flex:flexBtn name="新增" bclass="add" onpress="noticeList.add"></flex:flexBtn>	
		<flex:flexBtn name="发布" bclass="look" onpress="noticeList.publish"></flex:flexBtn>
	</flex:flexgrid>
</body>
</html>
