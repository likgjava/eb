...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/es/planform/projrule/reserveOpenBidRoomFrom.js"></script>
<form id="reserveRoomFrom" method="post">
	...
	<div class="formTips">
	 ...
	 <div class="conOperation">
		<button class="btn primary" id="projectSave" type="button" tabindex="18"><span>预订开标室</span></button>
	</div>