    	  ...
    	  for(var i=0;i<ro.meetRooms.length;i++) {
     	   ...
     	   var meetRoomId = ro.meetRooms[ro.meetRooms.length-1-i].objId;
       	   var  roomName = ro.meetRooms[ro.meetRooms.length-1-i].meetRoomName;
       	   	...
       	   	$("#title").after('<tr class="content" name="Morning"><td>'+roomName+' <span class="sysicon siExit" title="删除开评室" name="'+meetRoomId+'"></span></td><td class="mon"><span class="orderRoom">空闲</span></td><td class="tue"><span class="orderRoom">空闲</span></td><td class="wed"><span class="orderRoom">空闲</span></td><td class="thu"><span class="orderRoom">空闲</span></td><td class="fri"><span class="orderRoom">空闲</span></td><td class="sat"><span class="orderRoom">空闲</span></td><td class="sun"><span class="orderRoom">空闲</span></td></tr>');	
        	    ...
        	    $(".orderRoom").click(function(){
        	    	...
        	    	if($(this).text()=="空闲"){
        	    		...
        	    		if(rtime<=today){
        	    			...
        	    			$.epsDialog({
            	    	        title:'开标室信息',
            	    	        url:$('#initPath').val()+'/view/es/planform/projrule/reserveOpenBidRoomFrom.jsp?rid='+rid+'&rtime='+rtime+'&timBuc='+timBuc+'&projpackId='+$("#projpackId").val(),
            	    	        width: '450',
            	    	        height: '230',
            	    	        onOpen: function(){ },
            	    	        afterLoad: function(){ },
        	    		...
        	    		$.epsDialog({
        	    	        title:'禁用开标室信息',
        	    	        url:$('#initPath').val()+'/view/es/planform/projrule/openBidRoomForView.jsp?rid='+rid+'&timBuc='+timBuc+'&rtime='+rtime,
        	    	        width: '450',
        	    	        height: '230',
        	    	        onOpen: function(){ },
        	    	        afterLoad: function(){ },
