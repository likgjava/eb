...
taskPlanSubForCreateProj.success = function(){//加载成功后
	...
	$("#taskPlanSubForCreateProjGrid").flexAddOptionStr({
		'<span><a href="#" class="abtn"><u>划分标段</u></a>&nbsp;&nbsp;&nbsp;&nbsp;</span>' : function(btn,rowId,obj){
			btn.click(function(){
				$('#conBody').loadPage($('#initPath').val()+'/ProjectController.do?method=toCreateProjectByReProjectId&objId='+rowId);
			}).appendTo(obj);
		}
	});
}
