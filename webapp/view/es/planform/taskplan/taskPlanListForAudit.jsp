...
taskPlanListAudit.batchAudit = function(name,grid){
	...
	if(ids == ""){
		...
		json['ids'] =ids;
		json['passAction'] = 'TaskPlanController.do?method=auditStockTaskPlanPass';
		json['noPassAction'] = 'TaskPlanController.do?method=auditStockTaskPlanReject';
		$.epsDialog({
					title:'批量审核',
...
taskPlanListAudit.before=function(){
	//通过资金审核
	var option={"auditDetail":"02","confirmStatus":"01","leader.objId":PlatForm.user.emp.objId}
