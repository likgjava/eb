...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/es/planform/taskplan/addTaskPlanListForSupe.js"></script>
...
<input type="hidden" id="budgetName" value="${budgetName}">
<div id="consignListView">
	<flex:flexgrid checkbox="true"	id="addTaskPlanSubGrid" url="TaskPlanController.do?method=getTaskPlanSubListByConfirmConsign&taskType=${taskType}&ebuyMethod=${ebuyMethod}&taskPlanSubIds_not=${taskPlanSubIds_not}" queryColumns=""  
		searchZone="addTaskPlanSubSearchZone" rp="10" title="申报书明细"  
