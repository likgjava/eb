...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/es/planform/taskplan/taskPlanTDJYListForCreateProj.js"></script>
...
<div id="consignListView">
	<flex:flexgrid checkbox="true"	id="taskPlanSubForCreateProjGrid" url="TaskPlanMSubController.do?method=getAllTaskPlanSubListForCreateProj&taskType=02&isComplete=true" queryColumns="objId"  
