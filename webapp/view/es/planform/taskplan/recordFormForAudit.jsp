...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/es/planform/taskplan/recordFormForAudit.js"></script>
<div >     	
    <h5 align="center"><span>建设工程招标投标登记表</span></h5>
 	<p>&nbsp;</p>
		<div>
			 ...
			 <tr>
			 	<th width="10%" height="25" align="center" valign="middle">交易号：</th>
			 	<td height="25" >
			 		<span id="recFormOrgName">${recordForm.recFormNo}</span>
		    	</td>
			 </tr>
			 <tr>
			...
			<ul>
				<li>
					<form id="recordFormAudit" method="post">
						<input type="hidden" value="${recordForm.objId}" id="recordFormId"/>
		...
		<div class="conOperation">
			<button type="button" id="passButton"><span>通过</span></button>
			<button type="button" id="noPassButton"><span>不通过</span></button>
