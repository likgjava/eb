...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/es/planform/taskplan/taskPlanListForCreateProjBiXuan.js"></script>
...
<c:forEach items="${messageList}" var="mc">
  <li>
	  	  <a  href="#consignListView" id="project${mc.code}" class="refreshData"> 分标段</a>
 </li>
 </c:forEach>
</ul>
...
<div class="conOperation">
	<input type="hidden" name="reProjectobjId" id="reProjectobjId" value=""/>
</div>
