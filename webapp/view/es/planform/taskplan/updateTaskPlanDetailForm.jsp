...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/es/planform/taskplan/updateTaskPlanDetailForm.js"></script>
<div class="paper">
	<form id="taskPlanDetailForm" method="post">
		...
		<input type="hidden"  id="quantity2" value="<c:out value="${param.quantity}"/>"/>
        <table class="tableListP">
            <tr>
	     	...
	     	<tr>
				...
				<td><input type="text" name="superiorApp" id="superiorApp" class="number" onblur="taskPlanDetailForm.changeQuantity();" maxlength="15"
						onkeyup="taskPlanDetailForm.showmoney('superiorApp')"/>
    	   			<span class="eleRequired" ></span><span id="superiorApp2"></span></td>
    	    </tr>
	     	<tr>
	     		<th><label class="short" for="taskPlanDetailForm.localApp"><spring:message code="taskPlanDetailForm.localApp"/>（元）</label></th>
				<td><input type="text" name="localApp" id="localApp" class="number" onblur="taskPlanDetailForm.changeQuantity();"  maxlength="15"
						onkeyup="taskPlanDetailForm.showmoney('localApp')" />
    	   			<span class="eleRequired" ></span><span id="localApp2"></span></td>
    	    </tr>
	     	<tr>
	     		<th><label class="short" for="taskPlanDetailForm.ownerApp"><spring:message code="taskPlanDetailForm.ownerApp"/>（元）</label></th>
				<td><input type="text" name="ownerApp" id="ownerApp" class="number"  onblur="taskPlanDetailForm.changeQuantity();"  maxlength="15"
						onkeyup="taskPlanDetailForm.showmoney('ownerApp')"  />
    	   			<span class="eleRequired" ></span><span id="ownerApp2"></span></td>
    	    </tr>
	     	<tr>
	     		<th><label class="short" for="taskPlanDetailForm.otherApp"><spring:message code="taskPlanDetailForm.otherApp"/>（元）</label></th>
				<td><input type="text" name="otherApp" id="otherApp" class="number"  onblur="taskPlanDetailForm.changeQuantity();"  maxlength="15"
						 onkeyup="taskPlanDetailForm.showmoney('otherApp')"  />
    	   			<span class="eleRequired" ></span><span id="otherApp2"></span></td>
    	    </tr>
    	    <tr>
