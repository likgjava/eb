...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/es/planform/taskplan/taskPlanUpdateForAgent.js"></script>
		...
		<form:hidden path="confirmStatus"></form:hidden>
     		...
     		<table class="tableListP">
					...
					<tr>
						...
						&nbsp;<span class="eleRequired">*</span></label></th>
						<td><form:input path="departmentLinkerTel"/></td>
					</tr>
					...
					<tr>
						...
						<th><label class="short" for="budgetLinkerTel"><spring:message code="taskPlanForm.budgetLinkerTel"/>
						    &nbsp;<span class="eleRequired">*</span></label></th>
						<td><input type="text" id="mobile" name="leader.mobile" class="required" value="${taskPlan.leader.mobile}"/></td>
					</tr>
					<tr>
