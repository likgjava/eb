...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/es/planform/taskplan/taskPlanDetail1.js"></script>
<div class="partContainers">
<div class="formLayout form2Pa">        
	<form:form id="taskPlanDetail_Form" method="post" modelAttribute="taskPlan">	
		<table>
			<tbody id="taskPlanFormBaseInfo">
				<tr>
		...
		<div class="conOperation" id="but_option">
			<button id="return_to_list" tabindex="20"><span><spring:message code="globe.return"/></span></button>
		</div>
</div>
</div>