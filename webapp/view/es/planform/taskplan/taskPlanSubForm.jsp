...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/es/planform/taskplan/taskPlanSubForm.js"></script>
<div class="paper">         
	   ...
	   <table class="tableListP">
			<tr>
				...
				<td style="width:30%"><input type="text" name="purchase.name" id="purchase.name" class="required sysicon siSearch" readonly="readonly"/>
				    <input type="hidden" name="purchase.objId" id="purchase.objId" /><span class="eleRequired"></span>				
                </td>
				
				<th class="short" style="width:20%"><label class="short" for="unit"><spring:message code="taskPlanSubForm.unit"/>
				    <span class="eleRequired">*</span></label></th>
				<td style="width:25%"><input type="text" name="unit" id="unit"  maxlength="15" class="required"/><span class="eleRequired"></span></td>
			</tr>
			<tr>
				<th class="short" style="width:25%"><label class="short" for="quantity"><spring:message code="taskPlanSubForm.quantity"/>
				    <span class="eleRequired">*</span></label></th>
				<td><input type="text" name="quantity" id="quantity" value="0" maxlength="6" class="required digits" /></td>
			</tr>
			<tr>
				<th class="short" style="width:25%"><label class="short" for="totalPrice"><spring:message code="taskPlanSubForm.totalPrice"/>（元）
				    <span class="eleRequired">*</span></label></th>
				<td colspan="3"><input type="text" name="totalPrice" id="totalPrice" value="0.0" class="required money" maxlength="12"
					  onkeyup="taskPlanSubForm.showmoney()" onblur="taskPlanSubForm.valid()"/>
					 <span class="eleRequired" id="view"></span><span id="totalPriceToMoney"></span>
			    </td>
			</tr>
		</table>
	</form>
		...
		<input type="hidden" name="objId" id="preqEntryId" value="" />
			...
			<tr>
				...
				<th class="short" style="width:20%"><label class="short" for="warrentyLen"><spring:message code="preqEntryForm.warrentyLen"/></label></th>
				<td style="width:25%"><input type="text"  name="warrentyLen" id="warrentyLen" maxlength="25" /></td>
			</tr>
			<tr class="formTextarea" style="height:50px;">
			    <th class="short"><label class="short" for="paymentClause"><spring:message code="preqEntryForm.paymentClause"/></label></th>
			...
			<tr class="formTextarea" style="height:50px;">
				<th class="short"><label class="short" for="deliveryRequire"><spring:message code="preqEntryForm.deliveryRequire"/></label></th>
				<td colspan="3"><textarea name="deliveryRequire"  style="height:40px;" id="deliveryRequire" maxlength="200" class="maxInput"></textarea>
				  <span class="eleRequired"></span></td>
			</tr>
			<tr class="formTextarea" style="height:50px;">
				<th class="short"><label class="short" for="servicePromise"><spring:message code="preqEntryForm.servicePromise"/></label></th>
				<td colspan="3"><textarea name="servicePromise" style="height:40px;" id="servicePromise" maxlength="200" class="maxInput"></textarea>
				<span class="eleRequired"></span></td>
			</tr>
			<tr class="formTextarea" style="height:50px;">
				<th class="short"><label class="short" for="qualityAssurance"><spring:message code="preqEntryForm.qualityAssurance"/></label></th>
				<td colspan="3"><textarea name="qualityAssurance" style="height:40px;" id="qualityAssurance" maxlength="200" class="maxInput"></textarea>
				  <span class="eleRequired"></span></td>
			</tr>
			<tr class="formTextarea"  style="height:50px;" >
				<th class="short"><label class="short" for="acceptStandard"><spring:message code="preqEntryForm.acceptStandard"/></label></th>
				<td colspan="3"><textarea name="acceptStandard" style="height:40px;" id="acceptStandard" maxlength="200" class="maxInput"></textarea>
				<span class="eleRequired"></span></td>
			</tr>
			<tr class="formTextarea" style="height:50px;" >
				<th class="short"><label class="short" for="technical"><spring:message code="preqEntryForm.technical"/></label></th>
