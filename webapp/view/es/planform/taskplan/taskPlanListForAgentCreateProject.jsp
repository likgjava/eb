...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/es/planform/taskplan/taskPlanListForAgentCreateProject.js"></script>
<style>
<!--
...
<form id="budgetDetailForm" class="hidden">
	<div class="conSearch">
		<h4><span>导入采购预算</span></h4>
		<ul>
			<li class="fullLine" id="xmlUrlLi">
					预算XML文件：
  ...
  <div id="taskPlanListInfo">
	  <flex:flexgrid checkbox="true"
		id="taskPlanGrid" url="TaskPlanController.do?method=list" queryColumns="useStatus,auditDetail,confirmStatus,leader.objId,taskAgent.objId"   
			...
			onSubmit="taskPlanList.before" minGridHeight="140" height="239">
