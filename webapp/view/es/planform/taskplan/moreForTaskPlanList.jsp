...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/es/planform/taskplan/moreForTaskPlanList.js"></script>
 <style type="text/css">
<!--
	    ...
	    <ul>
	      ...
	      <li>
	        <label>名称：</label>
		  	...
		  	<input name="taskName_op" type="hidden" value="like">		
	      </li>
	      <li class="operationBtnDiv right">
	      	...
	      	<input type="hidden" name="taskAgentId" id="taskAgentId" value="${taskAgentId}" />
	      	<input type="hidden" name="taskType" id="taskType" value="${param.taskType}" />
	      </li>
	    </ul>
    </form>
</div>
...
<div id="epsTabs" class="">
  <div id="contractInfo">
    <flex:flexgrid checkbox="false"
		id="TaskPlanGrid" url="TaskPlanController.do?method=getTaskPlanList" queryColumns="" height="305"
			...
			onSubmit="TaskPlanList.before">
					...
					<flex:flexCol name="taskName" display="taskPlanForm.taskName" sortable="true" width="180" align="left"></flex:flexCol>
					...
					<flex:flexCol name="taskAgentName" display="taskPlanForm.taskAgent" sortable="true" width="150" align="left"></flex:flexCol>
