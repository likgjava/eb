...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/es/planform/buyresult/buy_winner_list.js"></script>
<style type="text/css">
<!--
				    	...
				    	<tbody>
				    		...
				    		for (Iterator iterator = winners.iterator(); iterator.hasNext();) {
				    			...
				    			<tr>
					    			...
					    			%>
					    			<td class="center">
					    			<a class="abtn" onclick="buy_winner_list.edit('<%=winner.getObjId() %>','${param.subProjectId}')" value="预览生成通知书">预览生成通知书</a>
					    			</td>
				    			</tr>
				    			<%
				    		}
