...
<%@ include file="/view/srplatform/common/taglibs.jsp"%>  
	...
	<c:forEach items="${subProjectList}" var="subProject" >
		<tr>
			...
			<td class="center">
				<c:choose>
			   <c:when test="${subProject.bidEvaluationReport!=null}"><a href="#"><span class="sysicon siEdit" onclick="evalBidRecordList.beginevalBidRecord('${subProject.objId}');" title=">查看定标结果 ">查看定标结果&nbsp;&nbsp;&nbsp;</span></a></c:when>
   ...
   evalBidRecordList.beginevalBidRecord =function(subProjId){
	  ...
	  $.epsDialog({
	       	title:'确认成交投标单位',
	       	url:$('#initPath').val()+'/BuyResultController.do?method=toConfigBuyResultViewList&subProjId='+subProjId+'&projectId='+$("#projectId").val(),
	       	width: '650',
	       	height: '350',
	       	isReload:false
		});	
