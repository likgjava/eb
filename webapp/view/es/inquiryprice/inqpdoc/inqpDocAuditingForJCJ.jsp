...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/es/inquiryprice/inqpdoc/inqpDocAuditingForJCJ.js"></script>
		...
		<form id="purchaseDocConfigForm" method="post">
     		<ul>
     			<li style="height:50px;">
					<textarea name="opinion" id="opinion" class="maxInput" maxlength="200" style="width: 99%;height: 45;">同意</textarea>
				</li>
			</ul>
	</form>
</div>
