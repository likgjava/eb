...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/es/singlesource/singlesourcedoc/singleSourceDocProcurement.js"></script>
...
<div id="downLoadView">
	<ul>
	   <li class="fullLine" >
  <span id="fileName"></span><a style="margin-left:25px; " href="#" onclick="InqpDocProcurement.downloadFile('${purchaseDoc.attachRelaId}');">点击下载</a>
	   </li>
	</ul>
	</div>
</div>
