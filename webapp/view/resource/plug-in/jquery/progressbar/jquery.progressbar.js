	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				width		: 100,											// Width of the progressbar - don't forget to adjust your image too!!!
				boxImage	: 'view/resource/plug-in/jquery/progressbar/images/progressbar.gif',						// boxImage : image around the progress bar
				barImage	: {
								0:	'view/resource/plug-in/jquery/progressbar/images/progressbg_red.gif',
								31: 'view/resource/plug-in/jquery/progressbar/images/progressbg_orange.gif',
								61: 'view/resource/plug-in/jquery/progressbar/images/progressbg_yellow.gif',
								91: 'view/resource/plug-in/jquery/progressbar/images/progressbg_green.gif'
			...
			this.construct = function(arg1, arg2) {
				...
				return this.each(function(child) {
					...
					var t = setInterval(function() {
						...
						bar.css("background-position", (((config.width * -1)) + (cpercentage * pixels) + (config.width - 120)) + 'px 50%');
