...
<div>
	<div>     
		...
		<textarea id="recommendReason" rows="5" cols="30" style="width: 365px; height: 180px"></textarea>
	</div>
...
$(document).ready(function(){
	...
	$("#OK").click(function(){
		...
		//保存
		$.getJSON($('#initPath').val()+'/RecommendGoodsBrandController.do?method=saveRecommendGoodsBrand',
    			{"goodsBrandIds":$("#goodsBrandIds").val(),"recommendReason":reason},
    			function(json){
    				if(json.success){
    					alert("推荐成功！");
