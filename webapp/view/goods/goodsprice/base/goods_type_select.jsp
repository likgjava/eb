...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/goods/goodsprice/base/goods_type_select.js"></script>
<style>
   .frameMain {
	width:185px;
	position:relative;
...
<div class="frameMainSub frameMS12 ">
    ...
    <div class="treeRight frameSub" id="treeRight">
        ...
        <form id="purCategoryTreeForm" action="" method="post">
        <h4><span>选择商品分类</span></h4>
        <ul>
        	...
        	<li>
                <label for="purCategoryNameSelect">商品分类名称</label>
                <select size="14" style="width:120px;height:200px;" id="purCategoryNameSelect" multiple="true"></select>
