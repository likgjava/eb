...
<div id="container"> 
  ...
  <!-- 接收初始路径参数，招标文件金额参数 ，支付返回调用方法参数，业务ID参数-->
	...
	<div class="page" style="min-height:600px!important;">
		<div class="gridBox">
	    	...
	    	<div class="bd_context">
	    		<!--导航 position-->
	    		<div class="bd_title">
					<div class="bd_t_name"><img  src="<%=request.getContextPath()%>/view/resource/skin/skin07/img/step1_bidding_pay.jpg" /></div>
					<div class="bd_t_guide">
					
					<div class="bd_t_pos pos_1_on">确定购买采购文件</div>
	    		...
	    		<div class="bd_main">
	    			<div class="bd_m_context">	
	    				...
	    				<div class="bd_post_form">
	   					...
	   					<div class="bd_post_form_line">
	   						<div class="bd_post_form_title"><span class="bd_post_form_must">&nbsp;</span>标书费(元)：</div>
	   						<div class="bd_post_form_context">
						...
						<div id="prepayDiv">
							<div class="bd_post_subscribe">	
								<div class="bd_post_submit">
									<a onclick="DocPay.toPrePayView();" class="bd_post_submit_btn">确定</a>
								</div>
