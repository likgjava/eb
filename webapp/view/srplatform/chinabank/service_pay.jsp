...
<!--页面容器 开始-->
<div id="container"> 
  <!-- 接收初始路径参数，订阅服务金额参数 ，支付返回调用方法参数，业务ID参数-->
	...
	<div class="page" style="min-height:600px!important;">
		<div class="gridBox">
	    	...
	    	<div class="bd_context">
	    		<!--导航 position-->
	    		<div class="bd_title">
					<div class="bd_t_name"><img  src="<%=request.getContextPath()%>/view/resource/skin/skin07/img/step1_service_pay.jpg" /></div>
					<div class="bd_t_guide">
					
					<div class="bd_t_pos pos_1_on">确定订购服务</div>
	    			...
	    			<div class="bd_m_context">	
	    				...
	    				<div class="bd_post_form">
	   					...
	   					<div class="bd_post_form_line">
	   						<div class="bd_post_form_title"><span class="bd_post_form_must">&nbsp;</span>服务总费用(元)：</div>
						...
						<div id="prepayDiv">
							<div class="bd_post_subscribe">	
								<div class="bd_post_submit">
									<a onclick="ServicePay.toPrePayView();" class="bd_post_submit_btn">确定</a>
								</div>
...
var ServicePay = {};
ServicePay.toPrePayView = function(){
