...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/srplatform/upload/many_attachments2.js"></script>
   ...
   <table>
      <tr>
       ...
       <tr>
        <th>图片上传：</th>
        <td colspan="3">
        	<div class="uploadFile2" id="contractFile">
       ...
       <tr>
        <th>文件上传：</th>
        <td colspan="3">
        	<div class="uploadFile" id="contractFile2">
