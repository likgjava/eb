...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/srplatform/auth/rol/roleListAll.js"></script>
	...
	<flex:flexgrid checkbox="true" height="262"
		id="roleGrid" url="RoleController.do?method=list" queryColumns=""  
			...
			onSubmit="roleList.before" onSuccess="roleListAll.success">
				...
				<flex:flexCol name="status" display="状态" sortable="true" width="50"align="center"></flex:flexCol>
