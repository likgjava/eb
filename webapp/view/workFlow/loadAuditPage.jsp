...
$(document).ready(function(){
	...
	$('#return').click(function(){
		$('#conBody').empty().loadPage($('#initPath').val()+'/WorkFlowController.do?method=loadWaitpTaskPage');
	})
...
<div class="partContainers">
	...
	<div class="conOperation" id="workFlowButton">
		...
		<button id="return" type="button" tabindex="19"><span><spring:message code="globe.return"/></span></button>
	</div>
</div>
