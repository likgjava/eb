...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/workFlow/ProcessDefNodeForm.js"></script>
<div class="partContainers formLayout form2Pa">
	<form method="post" name="ProcessDefNodeForm" id="ProcessDefNodeForm"  action="ProcessDefNodeController.do?method=save" >
