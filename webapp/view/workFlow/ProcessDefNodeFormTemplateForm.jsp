...
<div class="partContainers formLayout form2Pa">
    ...
    <div class="conOperation">
		...
		<button name="edit_work_flow_rule_expression" type="button" tabindex="19"><span>查看/编辑 规则表达式手册</span></button>
...
$('#save_node_form').click(function(){
	...
	$.getJSON($('#initPath').val()+'/ProcessDefNodeFormTemplateController.do?method=saveProcessDefNodeForm',json, function(json){
		if(json.result)alert(json.result);if(json.failure)return;
		$('#processDefNodeFormGrid').reload();
		$('#process_node_form_form .epsDialogCloseReload').click();
	});
})
$('[name=edit_work_flow_rule_expression]').click(function(){
	$.epsDialog({
		id:'work_flow_rule_expression_form',
        title:'编辑规则表达式',
        url:$("#initPath").val()+"/ProcessDefNodeFormTemplateController.do?method=toWorkFlowRuleExpressionFormView",
        width: '800',
        height: '500',
        maxWin:false,
        onClose: function(){
