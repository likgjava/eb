...
<div class="cols sameHeigh">
	<h2>服务</h2>
	<ul>
		<c:forEach var="project" items="${serviceProjectList}" varStatus="status">
		<li>
			<div class="announcementBox">
				...
				<ul>
					...
					<li>报名截止时间：<em><fmt:formatDate value="${serviceProjectRuleList[status.index].signUpETime}" pattern="yyyy-MM-dd HH:mm"/></em> </li>
	...
	<div class="more">
		<a title="点击查看更多" href="javascript:void(0);" onclick="ShowBiddingIndex.toBiddingProjectListView('C');">更多</a>
	</div>
</div>