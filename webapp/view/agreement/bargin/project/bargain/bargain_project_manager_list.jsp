...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/agreement/bargin/project/bargain/bargain_project_manager_list.js"></script>
	  ...
	  <div id="reverseProjectListInfo">
	    <table id="BargainProjectQueryList" class="frontTableList">
	      <thead>
	          ...
	          <th width="150px;" class="omission" omiLength="10">采购人</th>
