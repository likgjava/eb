...
show_list.makeSearchData=function(firstPage){
	...
	var url = $('#initPath').val()+"/ProjectShowController.do?method=getBiddingProjectListForShow";
...
$(document).ready(function(){
	...
	//推荐采购项目
	$("#reconmendDiv").loadPage($('#initPath').val()+'/ProjectShowController.do?method=toRecommendProjectSuppView&rp=5&page=1');
});