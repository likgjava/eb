...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/agreement/bargin/project/showproject/show_bidding_project_list.js"></script>
...
<div id="container">
	...
	<div id="sysContent" class="page">
		...
		<div id="contentMain" class="index2paL">
		 	<div id="conTitle"><div class="navCurrent">电子招标项目展示</div></div>
		    <!--功能页内容-->
		    <div id="conBody">
		    	<!--已选择采购品目 开始 -->
		    	...
		    	<div class="selectCategory">
		    		<div class="choosed">
						<h3>您已选择采购品目: </h3>
						<a title="${purCategoryName}" href="<%=request.getContextPath()%>/ProjectShowController.do?method=toShowBiddingProjectList&rp=21&page=1">${purCategoryName}<b></b></a>
					</div>
				</div>
				</c:if>
				<!--已选择采购品目 结束-->
				...
				<div id="ListSubCategory">
					<div class="SubCategoryBox">
						...
						<ul class="CategoryListTableLevel1 expand" id="moreProp2">
							<div id="propDisp1">
								<li><a href="javascript:void(0);" name="" >金额不限</a></li>
								<li>
				...
				<div class="SubCategoryBox">
					...
					<input type="hidden" name="ebuyMethod" value="00" />
		   			<table style="width:100%">
						<tbody>
							<tr>
								...
								<td><input type="checkbox" name="isRecommendProject" <c:if test="${isRecommendProject}">checked="checked"</c:if> /><label> 推荐招标项目</label></td>
			    ...
			    <div class="conrank">
					<ul>
						...
						<li class="proAmount">共&nbsp;<strong><span id="totalAmount">${PAGERESULT.totalRowNum }</span></strong>&nbsp;个招标项目</li>
					</ul>
			    </div>
				<!--排序方式 结束-->
				...
				<div id="showSuppListAndPic">
					<%@ include file="/view/agreement/bargin/project/showproject/bidding_project_list_div_l.jsp" %>
				</div>
				<!--招标项目列表结束-->
			</div>
		</div>
