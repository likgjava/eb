...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/agreement/order/order/order_choose_task.js"></script>
...
<div class="conOperation">	
		<button  id="saveOrderTask" type="button"><span>保存</span></button>
