...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/agreement/contract/contract_purchaser_detail.js"></script>
...
<!--  订单商品列表-->
 ...
 <div class="conOperation">				
   	 	<button  id="return" type="button" ><span>返回</span></button>  
