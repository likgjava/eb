...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/agreement/contract/contract_purchaser_list.js"></script>
...
<div id="epsTabs" class="">
  ...
  <div id="contractInfo">
    <!-- 合同列表 -->
    <table class="frontTableList" id="ContractPurchaserList">
      <thead>
      	<tr>
