...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/agreement/contract/contract_purchaser_confirm.js"></script>
...
<form id="contractForm" method="post">
  ...
  <ul>
      ...
      <li class="fullLine"><label>合同编号：</label>
      		<input name="contractNo" id="contractNo" class="required"/><span class="eleRequired">*</span>
