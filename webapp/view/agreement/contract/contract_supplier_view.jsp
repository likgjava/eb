...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/agreement/contract/contract_supplier_view.js"></script>
...
<form id="contractForm2">
   ...
   <ul>
      <li class="formTextarea"><label>供应商意见：</label><textarea name= "supplierOption" maxlength="100"></textarea></li>
  </ul>
</form>
</div>
