...
<title>最近3年有重大工程质量问题单位禁止投标- 【阳光易购】</title>
...
<div id="container">
	...
	<a href="javascript:void(0)" id="/view/staticpags/zjszjq/2c9087922e6f5c1a012e748659d1065f.jsp" title="最近3年有重大工程质量问题单位禁止投标" class="cmsHref_self">最近3年有重大工程质量问题单位禁止投标</a>
			...
			<div id="conBody">
				...
				<div class="frameNews">
					<h1>最近3年有重大工程质量问题单位禁止投标</h1>
					<div class="source">
						<span>发布时间：2011-03-02</span>
						<span>发布人：zol-manager  </span>
					</div>
					<p>没找到最近3年有重大工程质量问题单位禁止投标r的内容文件！</p>
				</div>
			</div>
		</div>
	</div>
