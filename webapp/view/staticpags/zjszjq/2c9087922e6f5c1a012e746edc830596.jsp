...
<title>网络招标和传统方式的招标有什么不同- 【阳光易购】</title>
...
<div id="container">
	...
	<a href="javascript:void(0)" id="/view/staticpags/zjszjq/2c9087922e6f5c1a012e746edc830596.jsp" title="网络招标和传统方式的招标有什么不同" class="cmsHref_self">网络招标和传统方式的招标有什么不同</a>
			...
			<div id="conBody">
				...
				<div class="frameNews">
					<h1>网络招标和传统方式的招标有什么不同</h1>
					<div class="source">
						<span>发布时间：2011-03-02</span>
						<span>发布人：zol-manager  </span>
					</div>
					<p>没找到网络招标和传统方式的招标有什么不同r的内容文件！</p>
				</div>
			</div>
		</div>
	</div>
