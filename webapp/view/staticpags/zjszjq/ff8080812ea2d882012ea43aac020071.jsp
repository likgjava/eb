...
<div id="container">
	...
	<a href="javascript:void(0)" id="/view/staticpags/zjszjq/ff8080812ea2d882012ea43aac020071.jsp" title="评选厂商有哪些客观标准？" class="cmsHref_self">评选厂商有哪些客观标准？</a>
			...
			<div id="conBody">
				...
				<div class="frameNews">
					...
					<p><p>评选厂商的客观标准包括一般经营状况、制造、技术、财务状况、品管能力及管理制度。</p>
</p>
				</div>
			</div>
		</div>
