...
<title>用工成本增加 西欧服装采购商陷入困境- 【阳光易购】</title>
...
<div id="container">
	...
	<a href="javascript:void(0)" id="/view/staticpags/supplierzx/ff8080812fbfbecc012fd78643310c84.jsp" title="用工成本增加 西欧服装采购商陷入困境" class="cmsHref_self">用工成本增加 西欧服装采购商陷入困境</a>
			...
			<div id="conBody">
				...
				<div class="frameNews">
					<h1>用工成本增加 西欧服装采购商陷入困境</h1>
					<div class="source">
						<span>发布时间：2011-05-10</span>
						<span>发布人：-  </span>
					</div>
					<p><p>据法国《纺织报》日前报道称，当前全球性金融和经济危机还未结束，接踵而来的是地缘政治的动荡，原材料价格指数的上涨，纺织业如同石油业经历着前所未有的价格波动。在此经济、社会和政治环境下，加之中国的变化，给西欧时尚品牌供应采购商带来了巨大的影响，使其处于两难境地。</p>
