...
<script type="text/javascript" src='<c:url value="/view/bizplatform/base/purcatalog/catalog_audit_form.js"/>'></script>
<div>
	...
	<div class="formLayout form2Pa">
		...
		<ul>
			...
			<li class="formTextarea">
				<label>审核意见：</label>
				<textarea name="opinion">${purCatalog.opinion}</textarea>	
			</li>
		</ul>
	</div>
	</form:form>
	...
	<div class="conOperation" id="catalogBtn">
		<button  id="auditPass"><span>审核通过</span></button>
		<button  id="auditNoPass"><span>审核不通过</span></button>
