...
<%@ page contentType="text/html;charset=UTF-8"%>
  ...
  <div class="regMain formLayout">
    ...
    <div class="textCenter">
    	<em>注册成功...</em>
        <p>欢迎您加入阳光易购采购交易平台！<font color="red" size="4">请您登录系统</font>并<a name="addMyInfo" href="javascript:void(0);"><span class="sysicon siEdit">完善资料</span></a>，然后<font color="red" size="4">提交审核</font>...</p>
