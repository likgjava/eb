...
<script type="text/javascript" src="<%=request.getContextPath()%>/view/bizplatform/organization/manager/select_orginfo.js"></script>
...
<div class="conSearch">
	...
	<!-- orgType : m, s ,b ,a -->
	 ...
	 <input type="hidden" id="isManufacturer" value="${param.isManufacturer}"/>
	 <input type="hidden" id="filterVelue" value="${param.filterVelue}"/>
